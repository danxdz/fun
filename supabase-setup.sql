-- AutoBot Manager Database Setup for Supabase
...
CREATE TABLE IF NOT EXISTS "BotRuns" (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE TABLE IF NOT EXISTS "GitBranches" (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    name VARCHAR(255) NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_git_branches_project_id ON "GitBranches"("ProjectId");
CREATE INDEX IF NOT EXISTS idx_module_updates_project_id ON "ModuleUpdates"("ProjectId");
